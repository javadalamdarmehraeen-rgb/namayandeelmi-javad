    ...
    <div className="relative" ref={boxRef}>
      <div className="flex gap-2">
        <input
          ...
          className="w-full rounded-xl border border-slate-300 bg-white px-3 py-2.5 text-sm tracking-widest outline-none transition focus:border-teal-500 focus:ring-2 focus:ring-teal-100"
        />
        <button
          type="button"
          onClick={() => setOpen((v) => !v)}
      ...
      {open ? (
        <div className="fade-in absolute z-30 mt-2 w-[19rem] max-w-[92vw] rounded-2xl bg-white p-3 shadow-xl ring-1 ring-slate-200">
