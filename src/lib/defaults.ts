...
/** همه ستون‌های ممکن هر جدول — برای افزودن ستون حذف‌شده توسط مدیر */
export const AVAILABLE_COLUMNS: Record<string, { key: string; label: string }[]> = {
  pharmacies: [
    { key: "row", label: "ردیف" },
    { key: "repName", label: "نام نماینده" },
    { key: "dateShamsi", label: "تاریخ ثبت" },
    { key: "province", label: "استان" },
    { key: "city", label: "شهر" },
    { key: "region", label: "منطقه" },
    { key: "name", label: "نام داروخانه" },
    { key: "landline", label: "شماره ثابت" },
    { key: "managerName", label: "مسئول سفارش" },
    { key: "managerPhone", label: "شماره همراه" },
    { key: "address", label: "آدرس" },
    { key: "isPercent", label: "درصدی؟" },
    { key: "percentValue", label: "میزان درصد" },
    { key: "location", label: "لوکیشن" },
    { key: "nav", label: "مسیریابی" },
  ...
  doctors: [
    ...
    { key: "phone", label: "شماره همراه پزشک" },
    { key: "secretaryName", label: "نام منشی" },
    { key: "secretaryPhone", label: "شماره منشی" },
    { key: "address", label: "آدرس مطب" },
    { key: "otherAddresses", label: "آدرس مطب‌های دیگر" },
    { key: "isPercent", label: "درصدی؟" },
    { key: "percentValue", label: "میزان درصد" },
    { key: "location", label: "لوکیشن" },
    { key: "nav", label: "مسیریابی" },
  ...
  orders: [
    { key: "row", label: "ردیف" },
    { key: "repName", label: "نام نماینده" },
    { key: "dateShamsi", label: "تاریخ سفارش" },
    { key: "pharmacyName", label: "نام داروخانه" },
    { key: "managerName", label: "مسئول سفارش" },
    { key: "managerPhone", label: "شماره همراه" },
    { key: "address", label: "آدرس" },
    { key: "products", label: "اقلام سفارش" },
    { key: "totalUnits", label: "جمع تعداد" },
    { key: "totalBonus", label: "جمع جایزه" },
