...
/**
 * CORS بین دو دامنه برنامه.
 *
 * چون کلاینت ممکن است از ndcohub.ir به onrender.com (و بالعکس) درخواست بزند،
 * باید مبدأ مجاز و ارسال کوکی/هدر توکن اجازه داده شود.
 */
...
function isAllowed(origin: string) {
  ...
  // زیردامنه‌های همان دامنه اصلی و محیط توسعه
