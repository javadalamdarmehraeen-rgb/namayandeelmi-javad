...
/**
 * پروکسی کاشی نقشه برای حل خطای 403 در اینترنت ایران.
 *
 * مرورگر دیگر مستقیماً به tile.openstreetmap.org وصل نمی‌شود؛ درخواست از
 * دامنه خود برنامه به این Route می‌آید و سرور با User-Agent صحیح کاشی را
 * دریافت می‌کند. اگر یک منبع خطا بدهد، منابع دیگر خودکار امتحان می‌شوند.
 */
...
/** کاشی SVG خنثی در صورت قطع همه منابع — نقشه هیچ‌وقت 403/صفحه شکسته نشان نمی‌دهد */
function fallbackTile(z: number, x: number, y: number) {
  const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="256" height="256">
    ...
    <text x="128" y="224" text-anchor="middle" fill="#94a3b8" font-size="10" font-family="sans-serif">${z}/${x}/${y}</text>
  </svg>`;
