...
/**
 * پروکسی کاشی OpenStreetMap. مرورگر/Service Worker پاسخ را محلی کش می‌کند؛
 * در نتیجه محدوده‌هایی که کاربر دیده است بعداً بدون اینترنت هم نمایش داده می‌شوند.
 */
export async function GET(_req: Request, ctx: { params: Promise<{ z: string; x: string; y: string }> }) {
  ...
  try {
    ...
    // بردار جهان/استان‌ها همچنان روی نقشه نمایش داده می‌شود
